...
task=StringVar()
task_entry=Entry(frame,width=18,font="roboto 18",bd=0)
task_entry.place(x=10,y=7)
task_entry.focus()


button=Button(frame,text="ADD",font="roboto 20 bold",width=6,bg="#5a95ff",fg="#fff",bd=0,command=addtask)
...
listbox= Listbox(frame1,font=('roboto',12),width=40,height=16,bg="#32405b",fg="white",cursor="hand2",selectbackground="#5a95ff")
